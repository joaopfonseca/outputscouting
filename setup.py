...
# main outputscouting __init__ can detect if it is being loaded by the setup
# routine, to avoid attempting to load components that aren't built yet:
# the numpy distutils extensions that are used by imbalanced-learn to
# recursively build the compiled extensions in sub-packages is based on the
# Python import machinery.
builtins.__OUTPUTSCOUTING_SETUP__ = True
...
import outputscouting._min_dependencies as min_deps  # noqa

ver_file = os.path.join("outputscouting", "_version.py")
